...
else
{
	...
	/// @DnDHash : 18070929
	/// @DnDParent : 1ED0E5DA
	/// @DnDArgument : "code" "Nombre = "";$(13_10)Nombre = get_string_async("Escribe tu nombre" , "");$(13_10)guardar_archivo_honor(Nombre, obj_player.coins);$(13_10)"
	Nombre = "";
	Nombre = get_string_async("Escribe tu nombre" , "");
